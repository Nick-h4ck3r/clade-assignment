  ...
  return (
    <div className="flex flex-col gap-8 pt-4 pb-8 border-b">
      <div className="flex items-center gap-4">
        ...
        <div className="bg-green-100 pl-2 pr-2.5 rounded-full text-xs font-bold text-green-600 border border-green-600 flex items-center gap-1.5">
          <span className="text-xl">&#x2022;</span>
          <span>Open</span>
        </div>
      </div>

      <div className="flex gap-6 text-base font-semibold text-gray-500 *:flex *:items-center *:gap-1.5">
        <div>
